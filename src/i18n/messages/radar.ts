...
export const enRadarMessages: RadarMessages = {
  ...
  partialReason: (reason, windowDays) => ({
    ...
    following_cap_reached: `Following coverage is limited to ${RADAR_MAX_FOLLOWING} followed accounts.`,
  })[reason],
...
export const zhRadarMessages: RadarMessages = {
  ...
  partialReason: (reason, windowDays) => ({
    ...
    following_cap_reached: `Following 最多覆盖你关注的 ${RADAR_MAX_FOLLOWING} 个账号。`,
  })[reason],
