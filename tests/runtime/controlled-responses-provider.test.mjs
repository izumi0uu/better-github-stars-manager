...
describe('controlled Responses provider CDP lifecycle', () => {
  ...
  it('classifies GitHub contents routes by exact path and method semantics', async () => {
    const fixtures = new Map([
      ...
      ['GET github-owned-repos', {
        status: 200,
        contentType: 'application/json',
        body: '[]',
        kind: 'owned-repositories',
      }],
      ['GET github-repository-search', {
        status: 200,
        contentType: 'application/json',
    ...
    for (const request of [
      ...
      httpRequest('owned-repositories', 'https://api.github.com/users/octo/repos?type=owner&per_page=100&page=1', 'GET'),
      httpRequest('repository-search', 'https://api.github.com/search/repositories?q=topic%3Aruntime&per_page=100&page=1', 'GET'),
    ...
    assert.deepEqual(
      ...
      [
        { kind: 'owned-repositories', method: 'GET', route: 'github-owned-repos', status: 200 },
        ...
        { kind: 'repository-search', method: 'GET', route: 'github-repository-search', status: 200 },
    ...
    assert.deepEqual(
      ...
      [
        ...
        ['file-read', 206],
        ['file-write', 201],
        ['owned-repositories', 200],
        ['repository-search', 200],
